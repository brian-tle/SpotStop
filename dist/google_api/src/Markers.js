const ICON_COLOR_RED = 'ff0000';
const ICON_COLOR_GREEN = '51c944';
...
class Marker {
  ...
  createMarker(map) {
      if (this.totalPoints > 45) { this.color = ICON_COLOR_GREEN; } 
      else if (this.totalPoints < 15) { this.color = ICON_COLOR_RED; } 
      else {this.color = ICON_COLOR_GRAY; }
